...
@allure.description("Сквозной тест (e2e): авторизация пользователя, добавление нескольких товаров в корзину, заполнение данных для доставки и проверка итоговой суммы.")
...
def test_form_submission_flow(driver):
    ...
    with allure.step("Добавление товаров в корзину (backpack, bolt-t-shirt, onesie)"):
        main.add('backpack')
