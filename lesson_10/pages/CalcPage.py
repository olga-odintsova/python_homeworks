...
class CalcPage:
    ...
    def __init__(self, driver: WebDriver) -> None:
        ...
        Args:
            driver (WebDriver): Экземпляр веб-драйвера Selenium для управления браузером.
    ...
    def fill_delay(self) -> None:
        """
        Находит поле ввода задержки (delay), очищает его и устанавливает значение "45".
    ...
    def fill_form(self) -> None:
        """
        Вводит математическое выражение "7 + 8 =", нажимая соответствующие кнопки на странице.
    ...
    def check_result(self) -> bool:
        """
        Ожидает появления правильного результата ("15") на экране калькулятора.

        Returns:
            bool: Возвращает True, если ожидаемый текст появился в элементе за время ожидания (таймаут).
